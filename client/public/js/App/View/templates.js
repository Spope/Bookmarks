angular.module('bookmarkApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('js/App/View/Bookmarks/bookmark.html',
    "<a class=url-bookmark href={{bookmark.url}} target=_blank title={{bookmark.name}}><img ng-src=\"http://www.google.com/s2/favicons?domain={{bookmark.url|removeHTTP}}\" height=16 width=\"16\"> {{bookmark.name|truncate:24}}</a>"
  );


  $templateCache.put('js/App/View/Bookmarks/folder.html',
